...
use fontdb::{Query, Family, Database};
...
impl FontInfo {
	...
	getter!(get_filename, filename, regular_data, doc="Filename of the regular font");
	getter!(get_bold, bold, bold_data, doc="Filename of the bold font");
	getter!(get_italic, italic, italic_data, doc="Filename of the italic font");
	getter!(get_bolditalic, bolditalic, bolditalic_data, doc="Filename of the bold italic font");
...
pub static DEFAULT_SANS_SEMIBOLD_ITALIC: &[u8] = include_bytes!("fonts/OpenSans-SemiBoldItalic.ttf");
